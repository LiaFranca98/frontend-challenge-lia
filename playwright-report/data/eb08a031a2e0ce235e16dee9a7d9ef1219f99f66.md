...
- Name: e2e/advanced.spec.ts >> Advanced Flows >> Checkout - Simula falha 500 no backend
- Location: tests/e2e/advanced.spec.ts:34:3
...
Locator: getByText(/Erro|Internal Server Error/i)
Expected: visible
Error: strict mode violation: getByText(/Erro|Internal Server Error/i) resolved to 2 elements:
    1) <div class="p-4 mb-4 bg-destructive/10 text-destructive text-sm rounded">Internal Server Error</div> aka getByText('Internal Server Error').first()
    2) <div class="p-4 bg-destructive/10 text-destructive text-sm rounded">Internal Server Error</div> aka getByText('Internal Server Error').nth(1)

Call log:
  - Expect "toBeVisible" getByText(/Erro|Internal Server Error/i) with timeout 10000ms
  - waiting for getByText(/Erro|Internal Server Error/i)
      ...
      - generic [ref=e36]:
        ...
        - generic [ref=e40]:
          ...
          - generic [ref=e83]:
            ...
            - generic [ref=e128]: Internal Server Error
