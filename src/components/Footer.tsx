...
export function Footer() {
  return (
    <footer className="w-full text-foreground">
      ...
      <div className="bg-[#1A110C] border-y border-[#3F2319]">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 divide-y lg:divide-y-0 lg:divide-x divide-[#3F2319]">
            ...
            <div className="lg:col-span-3 grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#3F2319]">
              <div className="p-8 xl:p-12">
                ...
                <h4 className="font-bold text-lg mb-3 font-sans text-white">Segurança da carteira</h4>
              ...
              <div className="p-8 xl:p-12">
                ...
                <h4 className="font-bold text-lg mb-3 font-sans text-white">Criadores em destaque</h4>
              ...
              <div className="p-8 xl:p-12">
                ...
                <h4 className="font-bold text-lg mb-3 font-sans text-white">Alertas de lançamentos</h4>
            ...
            {/* Newsletter */}
            <div className="lg:col-span-1 p-8 xl:p-12 bg-[#22160F]">
              <h4 className="font-bold font-mono-style text-base mb-6 text-white leading-tight">Antecipe-se ao próximo<br />lançamento</h4>
              <div className="flex w-full mb-6">
                ...
                />
                <button className="bg-primary text-primary-foreground font-bold px-6 py-3 hover:bg-primary/90 transition-colors rounded-none whitespace-nowrap">
                  Enviar
                </button>
              </div>
      ...
      <div className="bg-[#38220F] py-4">
        <div className="container mx-auto px-4 md:px-8 flex flex-col lg:flex-row justify-between items-center text-xs lg:text-sm gap-4">
          <div className="font-bold font-mono-style tracking-widest uppercase text-white">KURIO</div>
          <div className="text-muted-foreground">Feito para colecionadores, criadores e cultura</div>
          <div className="text-muted-foreground font-mono-style">contato@email.com</div>
          <div className="text-muted-foreground font-mono-style">+55 11 4002 8922</div>
        </div>
      </div>

      {/* SEÇÃO 3: Links */}
      <div className="bg-background py-16">
        <div className="container mx-auto px-4 md:px-8 grid grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          <div>
            <h4 className="font-bold mb-6 font-sans text-white text-base">Meu perfil</h4>
            <ul className="space-y-4 text-sm text-muted-foreground font-sans">
              <li><Link to="/" className="hover:text-primary transition-colors">Meu perfil</Link></li>
          ...
          <div>
            <h4 className="font-bold mb-6 font-sans text-white text-base">Central de ajuda</h4>
            <ul className="space-y-4 text-sm text-muted-foreground font-sans">
          ...
          <div>
            <h4 className="font-bold mb-6 font-sans text-white text-base">Coleções</h4>
            <ul className="space-y-4 text-sm text-muted-foreground font-sans">
          ...
          <div>
            <h4 className="font-bold mb-6 font-sans text-white text-base">Redes sociais</h4>
            <div className="flex gap-3 mb-10">
              <div className="w-10 h-10 border border-[#3F2319] rounded-none flex items-center justify-center hover:border-primary hover:text-primary transition-colors cursor-pointer text-muted-foreground">
            ...
            <h4 className="font-bold mb-4 font-sans text-white text-base">Carteiras compatíveis</h4>
            <div className="flex gap-2">
              <div className="border border-border text-[10px] px-2 py-1 font-mono-style text-muted-foreground">UNISWAP</div>
              <div className="border border-border text-[10px] px-2 py-1 font-mono-style text-muted-foreground">MULTICHAIN</div>
              <div className="border border-border text-[10px] px-2 py-1 font-mono-style text-muted-foreground">CARDANO</div>
            </div>
          </div>
        </div>
        <div className="text-center text-xs text-muted-foreground font-mono-style mt-20">
